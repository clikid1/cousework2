...
<form action="">
          ...
          <a class="navbar-brand" href="searchOption.html">Search Recipes</a> 
...
$recipeinstruc = $_POST['recipe_instruc'];

$category = $_POST['category'];

$recipeingri = $_POST['recipe_ingri'];
...
if (move_uploaded_file($_FILES['fileToUpload']['tmp_name'], $saveFile)){
    ...
    echo "Recipe Instruction: ".$recipeinstruc."<br>";

	echo "Category: ".$category. "<br>";

	echo "Recipe Ingridients: ".$recipeingri."<br>";
	...
	echo "Upload Did Not Work<a href='./chefhome.html'> Go Back</a>";
...
$sql = "insert into recipe(chef_name, recipe_name, recipe_instruc, recipe_image, category, recipe_ingri)values('$chefname','$recipename','$recipeinstruc','$saveFile','$category ','$recipeingri')";
...
<h1><a href="./picgalleryDB.php">Back to Gallery</a></h1> 
