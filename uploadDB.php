...
$tags = $_POST['recipe_name'];

$description = $_POST['recipe_instruc'];
...
if (move_uploaded_file($_FILES['fileToUpload']['tmp_name'], $saveFile)){
	...
	echo "Recipe Description: ".$description."<br>";

	echo "Recipe Name: ".$tags."<br>";
...
$sql = "insert into recipe (chef_name, recipe_name, recipe_instruc, recipe_image, category  )values('$chefname','$tags','$description','$saveFile','$category')";
