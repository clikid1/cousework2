...
<div class="menuBar">
    ...
    <a href="./uploadFormDB.html">Upload Pictures To Database</a><br>
...
$sql = "select chef_name, recipe_image, recipe_instruc FROM recipe";
...
if ($result->num_rows > 0 ){
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<div class='pictureBox'><br>Chef Name:   ".$chefname." <br>Pic Name: ".$imgSrc."<br>Recipe Description: ".$imgDescription."<br><br><img src='".$imgSrc."'><br><br></div><br><br>";
